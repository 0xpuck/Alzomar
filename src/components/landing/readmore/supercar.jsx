...
export default function SupercarReadmore() {
        ...
        <div className="w-full xl:pt-28">
            <div className="w-full items-content justify-center flex bg-[#1845aa] py-7">
                <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 flex">
                    <div className="w-1/2">
                        <span className="text-white text-xl">SUPERCAR BLONDIE 2022</span>
                    </div>
                    <div className="w-1/2 flex flex-col items-end justify-center">
                        <div className="text-white text-xs">
                            <a href="/">Home</a><span> > </span><a href="/">News & Events</a><span> > </span><span className="text-white text-xs">Supercar Blondie 2022</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="lg:w-4/5 w-full mx-5">
                        <div className="w-full px-3">
                            <div className="w-full mb-16">
                                <img src="./img/landing/readmore/supercar/back.jpg" className="w-full mb-5" />
                                <p className="text-2xl text-gray-700 font-bold">SUPERCAR BLONDIE 2022</p>
                                <p className="text-lg">Our new super intelligent robodogs were featured on Supercar Blondie’s YouTube channel!</p>
                            </div>
                                            ...
                                            imgs.map(img =>
                                                <li>
                                                    <div className="w-full lg:pb-10 sm:pb-0 lg:h-48 bg-white px-3">
                                                        <img src={`./img/landing/readmore/supercar/${img}`} className="border-2 hover:cursor-pointer transition duration-500 w-full" />
                                                    </div>
                                                </li>
                                            )
                                        }
