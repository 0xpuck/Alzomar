            ...
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    <p className="text-lg text-gray-500">
                        ...
                        <br /><br />EFFICIENT
                        <br />Full Scanning TFT 300mA <br /> Suspend 2mA
                    </p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={3}
