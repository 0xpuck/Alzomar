        ...
        <div className="w-full flex flex-col">
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    <p className="text-lg text-gray-500">
                        ACCURATE
                        <br />Provides accurate high-resolution fingerprint scans in virtually any environment: indirect or direct sunlight, a factory, etc. LES fingerprint sensors are not easily confused by foreign matter
                        <br /><br />
                        EFFICIENT
                        <br />Full Scanning 130mA
                        <br />Sleep Mode 2mA
                        <br />Stand By 40mA
                        <br /><br />
                        COLUMBO OEM
                        <br />Comes with a full featured SDK to enable effective integration into applications requiring certified FAP 30 quality images
                        <br /><br />
                        DURABLE
                        <br />Able to withstand the toughest operating environments with minimal maintenance
                    </p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={3}
