            ...
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    <p className="text-lg text-gray-500">
                        ...
                        <br /><br />>>Sunlight tolerant biometric sensors
                        <br /><br />>>Stand-off iris capture
                        <br /><br />>>Rugged, compact design, yet lightweight
                        <br /><br />>>Large touchscreen and keyboard with optical mouse
                    </p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={3}
