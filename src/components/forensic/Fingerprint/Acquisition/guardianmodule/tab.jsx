    ...
    return (
        <div className="w-full flex flex-col">
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    <p className="text-lg text-gray-500">
                        >>Compact housing requires less space
                        <br /><br />>>Multiple mounting points for easy integration
                        <br /><br />>>Advance design provides superior wet and dry print capture
                        <br /><br />>>Robust SDK tools for customization
                        <br /><br />>>Intuitive user guidance
                        <br /><br />>>Fully certified and ready for integration
                    </p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={3}
