    ...
    return (
        <div className="w-full flex flex-col">
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    <p>Handheld Raman Spectroscopy with Rapid Laser Spin (RLS™) Technology; Pocket-sized, laser-based identifier of drugs of abuse, explosives and precursors</p>
                    <br />
                    <p>With a PC and the included PEAK software, users can upload spectra or create their own libraries for downloading to the HandyRam™.</p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={2}
