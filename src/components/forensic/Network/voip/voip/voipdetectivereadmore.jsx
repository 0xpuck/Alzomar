...
export default function VoIPDetectiveReadmore() {
    return (
                ...
                <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 flex">
                    ...
                    <div className="w-1/2 flex flex-col items-end justify-center">
                        <div className="text-white text-xs">
                            <a href="/">Home</a><span> > </span><a href="/"> Network Forensics </a><span> > </span><span className="text-white text-xs">VOIP-DETECTIVE</span>
                        </div>
                    </div>
                </div>
            </div>
