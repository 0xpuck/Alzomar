        ...
        <div className="w-full flex flex-col">
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    ...
                    <br /><br />
                    >>XR200 – General Purpose 150 kV X-ray generator
                    <br />>>XRS-3 – Heavy Duty 270 kV X-ray generator
                    <br />>>XR150 – lightweight 150kV X-ray generator
                    <br /><br />
                    These pulsed Golden XR generators are battery powered and operate across the full range of Scanna x-ray imaging systems.  They can be fired manually using the x-ray delay button or via standoff cable when using imaging plates or by using ScanView Imaging software linked to a digital DR x-ray system (Scantrak/Scanwedge/Scansilc) on any Windows XP/7 laptop or tablet.
                    <br /><br />
                ...
                >
                    <p className="text-lg text-gray-500">
                        ...
                        <br /><br />>>7m firing cable
                        <br /><br />>>Collimator caps
                        <br /><br />>>Dual Energy Module
                    </p>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={2}
