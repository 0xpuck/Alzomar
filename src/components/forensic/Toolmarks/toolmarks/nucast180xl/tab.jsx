    ...
    return (
        <div className="w-full flex flex-col">
            <TabGroup numTabs={5} direction={TabGroup.direction.HORIZONTAL}>
                ...
                >
                    Why is NuCAST180 XL a better solution?
                    <br />NuCAST180 XL is the same formula as the NuCAST180 however with 1200g of casting powder it is ideal for larger footprints and Tyre Impressions.
                    <br />
                    <br />>>Pre-measured components for an accurate effective mixture every time
                ...
                >
                    <span className="text-lg text-gray-500">
                        ...
                        <br /><br />
                        >>Curing Time: 5 minutes (based on an ambient temperature of 21˚c.)
                        <br /><br />
                        >>Compression Strength: 1 hour: 3770 PSI; 48 hours: 8557 PSI (approx.)
                        <br /><br />
                        >>Expansion: 2 hours: 0.02% 48 hours: 0.06%
                    </span>
                </TabGroup.TabPanel>
                <TabGroup.TabPanel
                    index={3}
