...
class Rop extends React.Component {
    state = {
        ...
        photoIndex: 0,
        isOpen: false,
        images: ["../../img/projects/rop/1.jpg",
            "../../img/projects/rop/2.jpg",
            "../../img/projects/rop/3.jpg",
            "../../img/projects/rop/4.jpg",
            "../../img/projects/rop/5.jpg",
            "../../img/projects/rop/6.jpg",
            "../../img/projects/rop/7.jpg",
        ],
    };
    setVisible(state) {
            ...
            <div className="w-full xl:pt-28">
                <div className="w-full items-content justify-center flex bg-[#1845aa] py-7">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 flex">
                        <div className="w-1/2">
                            <span className="text-white text-xl">ROP BALLISTIC LAB</span>
                        </div>
                        <div className="w-1/2 flex flex-col items-end justify-end">
                            <div className="text-white text-xs">
                                <a href="/">Home</a><span> > </span><a href="/projects">Projects</a><span> > </span><span className="text-white text-xs">Rop Ballistic Lab</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full items-content justify-center flex">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 pt-16 items-content justify-center">
                        <div className="w-full px-5 text-gray-500 text-lg mb-8">
                            <span>The Royal Oman Police have the Water Bullet Recovery tank, water recovery tank is used to retrieve undamaged bullets.</span>
                        </div>
