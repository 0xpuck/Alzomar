...
class Ballistic extends React.Component {
    state = {
        visible: 0,
        photoIndex: 0,
        isOpen: false,
        images: ["../../img/projects/ballistic/1.png",
            "../../img/projects/ballistic/2.png",
            "../../img/projects/ballistic/3.png",
            "../../img/projects/ballistic/4.png",
            "../../img/projects/ballistic/5.png",
        ],
    };
    setVisible(state) {
            ...
            <div className="w-full xl:pt-28">
                <div className="w-full items-content justify-center flex bg-[#1845aa] py-7">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 flex">
                        <div className="w-1/2">
                            <span className="text-white text-xl">MOBILE BALLISTIC LABORATORY</span>
                        </div>
                        <div className="w-1/2 flex flex-col items-end justify-end">
                            <div className="text-white text-xs">
                                <a href="/">Home</a><span> > </span><a href="/projects">Projects</a><span> > </span><span className="text-white text-xs">Mobile Ballistic Laboratory</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full items-content justify-center flex">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 pt-16 items-content justify-center">
                        <div className="w-full px-5 text-gray-500 text-lg mb-8">
                            <span>The Mobile Ballistic Lab can be sent to remote locations where firearms can be examined and registered.</span>
                        </div>
