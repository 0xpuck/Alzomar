...
class Qatar extends React.Component {
    state = {
        visible: 0,
        photoIndex: 0,
        isOpen: false,
        images: ["../../img/projects/qatar/1.jpg",
            "../../img/projects/qatar/2.jpg",
            "../../img/projects/qatar/3.jpg",
        ],
    };
    setVisible(state) {
            ...
            <div className="w-full xl:pt-28">
                <div className="w-full items-content justify-center flex bg-[#1845aa] py-7">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 flex">
                        <div className="w-1/2">
                            <span className="text-white text-xl">QATAR HOSPITAL</span>
                        </div>
                        <div className="w-1/2 flex flex-col items-end justify-end">
                            <div className="text-white text-xs">
                                <a href="/">Home</a><span> > </span><a href="/projects">Projects</a><span> > </span><span className="text-white text-xs">Qatar Hospital</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full items-content justify-center flex">
                    <div className="xl:w-7/12 lg:w-8/12 md:w-9/12 sm:w-10/12 w-11/12 pt-16 items-content justify-center">
                        <div className="w-full px-5 text-gray-500 text-lg mb-8">
                            <span>SAT has successfully completed renovation of the Central Receiving Laboratory in Dubai hospital in December 2016. The well planned renovation was executed in no time in a live Laboratory, where samples where received in thousands. The renovation was meticulously planned and executed with perfection, and the quality of Waldner furniture added more value to the whole effort of the team.</span>
                        </div>
